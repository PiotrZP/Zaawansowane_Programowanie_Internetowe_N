...
public class OrderApiController : BaseApiController
{
    ...
    public IActionResult Get(int id)
    {
        try
        {
            var orders = _orderService.GetOrder(a => a.Id == id);
            return Ok(orders);
        }
        catch (Exception ex)
        {
    ...
    public IActionResult Delete(int id)
    {
        try
        {
            var result = _orderService.DeleteOrder(a => a.Id == id);
            return Ok(result);
        }
        catch (Exception ex)
        {
    ...
    private IActionResult PostOrPutHelper(AddOrUpdateOrderVm addOrUpdateOrderVm)
    {
        try
        {
            ...
            return Ok(_orderService.AddOrUpdateOrderVm(addOrUpdateOrderVm));
        }
        catch (Exception ex)
        {
