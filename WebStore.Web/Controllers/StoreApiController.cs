...
public class StoreApiController : BaseApiController {
    ...
    [HttpPut]
    public IActionResult Put([FromBody] AddOrUpdateStoreVm addOrUpdateStore) {
        return PostOrPutHelper(addOrUpdateStore);
    }

    [HttpPost]
    public IActionResult Post([FromBody] AddOrUpdateStoreVm addOrUpdateStore) {
        return PostOrPutHelper(addOrUpdateStore); 
    }
