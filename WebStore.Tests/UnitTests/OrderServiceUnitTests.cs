...
namespace WebStore.Tests.UnitTests
{
    public class OrderServiceUnitTests : BaseUnitTests
    {
        ...
        {
            var order = _orderService.GetOrder(o => o.InvoiceId == 657);
        ...
        public void AddNewOrderTest()
        {
            var newOrderVm = new AddOrUpdateOrderVm()
            {
                ...
                TotalAmount = 1456.63m,
                TrackingNumber = 355314,

            };
            var createdOrder = _orderService.AddOrUpdateOrder(newOrderVm);
            Assert.NotNull(createdOrder);
            Assert.Equal(1456.63m, createdOrder.TotalAmount);
        }
        ...
        public void UpdateOrderTest()
        {
            ...
            Assert.Equal(895235, editedOrderVm.TrackingNumber);
            Assert.Equal(4241.62m, editedOrderVm.TotalAmount);
        }
    }
}