...
public class ProductService : BaseService, IProductService
{
    ...
    ProductVm IProductService.AddOrUpdateProduct(AddOrUpdateProductVm addOrUpdateProductVm)
    {
    ...
    ProductVm IProductService.GetProduct(Expression<Func<Product, bool>> filterExpression)
    {
        throw new NotImplementedException();
    }

    IEnumerable<ProductVm> IProductService.GetProducts(Expression<Func<Product, bool>>? filterExpression)
    {
        throw new NotImplementedException();
    }
}