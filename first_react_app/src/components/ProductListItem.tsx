        ...
        return (
            <div className='product-item'>
                <div className='product-item-element'>
                    <label className='proudct-item-label'>Id</label>
                    <span className='product-item-span'>{this.props.id}</span>
                </div>
                <div className='product-item-element'>
                    <label className='proudct-item-label'>Name</label>
                    <span className='product-item-span'>{this.props.name}</span>
                </div>
                <div className='product-item-element'>
                    <label className='proudct-item-label'>Price</label>
                    <span className='product-item-span'>{this.props.price}</span>
                </div>
                <div className='product-item-element'>
                    <label className='proudct-item-label'>Type</label>
