        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerStationaryStoreId = table.Column<int>(name: "Customer_StationaryStoreId", type: "int", nullable: true),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_StationaryStores_Customer_StationaryStoreId",
                        column: x => x.CustomerStationaryStoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_StationaryStores_StationaryStoreId",
                        column: x => x.StationaryStoreId,
                        principalTable: "StationaryStores",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_StationaryStoreId",
                table: "Products",
                column: "StationaryStoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Customer_StationaryStoreId",
                table: "Users",
                column: "Customer_StationaryStoreId");
